 ...
 * ------------------------------------------------------------
 * This is unpublished proprietary source code of vighneshx
 *             ** For educational purposes only **                           
 * ------------------------------------------------------------
 * Usage: sudo ./0verl04dX -t <target> -p <port> -m <magnitude>
 * (vighneshx㉿rs)-$ gcc j0lt.c -o j0lt
 * (vighneshx㉿rs)-$ sudo ./j0lt -t 127.0.0.1 -p 80 -m 1337
 * ------------------------------------------------------------
 * Options:
 * [-x] will print a hexdump of the packet headers
 * [-d] puts 0verl04dX into debug mode, no packets are sent
